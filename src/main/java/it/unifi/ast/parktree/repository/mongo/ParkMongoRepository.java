...
public class ParkMongoRepository implements ParkRepository{
	...
	public ParkMongoRepository(MongoClient client, String dbName, String collectionName) {
	...
	public void save(Park park) {
		parkCollection.insertOne(new Document()
				.append("id", park.getId())
				.append("name", park.getName())
				.append("region", park.getRegion())
				.append("area", park.getArea())
