...
public class TreeMongoRepository implements TreeRepository {
	...
	public TreeMongoRepository(MongoClient client, String dbName, String collectionName) {
	...
	public void save(Tree tree) {
		treeCollection.insertOne(new Document()
				.append("id", tree.getId())
				.append("name", tree.getName())
				.append("evergreen", tree.isEvergreen())
				.append("mediumLifespan", tree.getMediumLifespan()));
	}
	...
	private Tree fromDocumentToTree(Document d) {
		return new Tree("" + d.get("id"), "" + d.get("name"), d.getBoolean("evergreen"), d.getInteger("mediumLifespan"));
	}
